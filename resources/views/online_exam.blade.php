...
<div class="container">
    <div class="row">
        <div class="col-12">
            ...
            <div class="block block-rounded block-transparent block-link-pop bg-primary mb-3 position-sticky" style="top: 65px;">
                <div class="block-content block-content-full d-flex align-items-center justify-content-between">
                    <div>
            ...
            <form id="answer-form" name="answer-form" action="" method="POST">
                @csrf
